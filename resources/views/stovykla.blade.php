    ...
    <div class="container-lg">
        ...
        <div class="grid">
            ...
            <div class="front">
                ...
                <article>
                    <h2>Stovykla suteikia</h2>
                    <p>Maitinimas įskaičiuotas : pietūs ir užkanžiai su vaisiais.</p>
                ...
                <article>
                    ...
                    <p>Norint užsiregistruoti, reikia užpildyti registracijos formą ir atlikti avansini 70 Eur pavedimą į "VšĮ Banglentė" sąskaitą - LT22 7300 0101 4459 4068 (swed). Neatvykus į stovyklą avansas negrąžinamas.</p>
                    <p>Visada mielai atsakysime į visus jums kylančius klausimus telefonu. </p>
                </article>
                
                <h2 class="text-center blink">Pamainos kaina 220€.</h2>
            </div>

            <div class="side">
                <h3>MUS REMIA</h3>
                <h4 class="pb-2">Iš dalies finansuojama Savivaldybės Lėšomis!</h4>
        ...
        <!--- 2017 metu galerija --->
        <div>
            <h3 class="m-2">2017 Vaikų vasaros stovykla</h3>
