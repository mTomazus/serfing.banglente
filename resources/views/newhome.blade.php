...
<body>
    ...
    <div id="fullpage"> <!--- FULLPAGE START --->
        ...
        <div class="s1 section"> 
            ...
            <div class="s11 slide">
                ...
                <div class="content landing">
                    ...
                    <section>
                        <ul class="listas">
                            <li>
                                <a aria-current="page" href="#">Pamokos ir Įrangos nuoma</a>
                            </li>
                            <li>
                                <a aria-current="page" href="#">Vaikų vasaros stovykla</a>
                            </li>
                        </ul>
                    </section>
                </div>
            ...
            <!-------------------------------------->
            <!------ Sekcija nr1 - 2 VARŽYBOS ------>
            <!-------------------------------------->

            <div class="s12 slide"> 

                <div class="content varzybos">
                    <h1>VARŽYBOS</h1>
                    <p> Molas Surf 2021</p>
                    <p>Longboard Classic</p>
                    <div id="container">
                        <button class="cta-btn learn-more">Info</button>
                    </div>
                    <div class="remejai">
                        <section>
        ...
        <!---------------------------------->
        <!------ SECTION nr3 STOVYKLA ------>
        <!---------------------------------->

        <div class="s3 section">

            <div class="content camp">
                <h1>VAIKŲ VASAROS DIENOS STOVYKLA 2021</h1>
                <h2>Jau penktus metus Lietuvos paplūdimiuose!</h2>
                <button>SPAUSK ČIA</button>
                <h3>Stovykla organizuojama nuo Birželio vidurio iki Rugpjūčio pabaigos. Grupės sudaromos iš 6-8 mokančių plaukti vaikų <strong>nuo 10 iki 18 metų.</strong></h3>
            </div>
        ...
        <div class="s4 section">
            ...
            <div class="content nuoma">
                    
                <h1>NUOMA</h1>         

                <div class="accordion__container">
                    <h3 class="accordion__button accordion__button--active">BANGLENTĖS</h3>
                    <div class="accordion__content" style="">
                        <!--------- Carousel --------->
                        <div class="carousel banglentes">
                            <button class="b-left is-hidden">
                                <img src="./img/left-solid.svg" alt="">
                            </button>
                            <div class="track-container">
                                <ul class="carousel-track">
                                    <li class="carousel-slide current-slide">
                                        <img src="./img/lenta-9.jpg" alt="">
                                    </li>
                                    <li class="carousel-slide current-slide">
                                        <img src="./img/lenta-1.jpg" alt="">
                                    </li>
                                    <li class="carousel-slide">
                                        <img src="./img/lenta-2.jpg" alt="">
                                    </li>
                                    <li class="carousel-slide">
                            ...
                            <button class="b-right">
                                <img src="./img/right-solid.svg" alt="">
                            </button>
                ...
                <div class="accordion__container rent">
                    <h3 class="accordion__button">HIDROKOSTIUMAI</h3>
                    <div class="accordion__content" style="display: none;">
                        <img src="./img/wetsuit-1.jpg" alt="">
                        <div class="info">
                            <p>vyriški</p><br>
                            <p>moteriški</p><br>
                            <p>vaikiški</p><br>
                ...
                <div class="accordion__container rent">
                    <h3 class="accordion__button">IRKLENTĖS</h3>
                    <div class="accordion__content" style="display: none;">
                        <img src="./img/sup-1.jpg" alt="">
                        <div class="info">
                            <p>10 pėdų</p>
                            <p>11 pėdų</p><br>
                            <p>kietos</p><br>
                ...
                <div class="accordion__container rent">
                    <h3 class="accordion__button">RIEDLENTĖS</h3>
                    <div class="accordion__content" style="display: none;">
                        <img src="./img/skate-1.jpg" alt="">
                        <div class="info">
                            <p>Carver</p>
                            <p>SmoothStar</p><br>
                            <p>surfskate</p><br>
        ...
        <!----------------------------------->
        <!------ SECTION nr5 KONTAKTAI ------>
        <!----------------------------------->
        
        <div class="s5 section">
            <div class="content">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem ipsa rerum distinctio, non voluptatum qui enim veritatis? At autem deserunt exercitationem consequatur soluta, nemo, sapiente .</p>
                <div class="footer__kontaktai">
                    <img src="/img/naujas-title.png" alt="banglente logo">
                    <h2>VšĮ Banglentė</h2>
                ...
                <div class="footer__knopkes">
                    <a href="tel:+370-686-02356"><svg class="svg-icon" viewBox="0 0 20 20">
                        <path d="M13.372,1.781H6.628c-0.696,0-1.265,0.569-1.265,1.265v13.91c0,0.695,0.569,1.265,1.265,1.265h6.744c0.695,0,1.265-0.569,1.265-1.265V3.045C14.637,2.35,14.067,1.781,13.372,1.781 M13.794,16.955c0,0.228-0.194,0.421-0.422,0.421H6.628c-0.228,0-0.421-0.193-0.421-0.421v-0.843h7.587V16.955z M13.794,15.269H6.207V4.731h7.587V15.269z M13.794,3.888H6.207V3.045c0-0.228,0.194-0.421,0.421-0.421h6.744c0.228,0,0.422,0.194,0.422,0.421V3.888z"></path>
                    </svg></a>
                    <a href="mailto:sales@banglente.com"><svg class="svg-icon" viewBox="0 0 20 20">
