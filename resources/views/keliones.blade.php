                ...
                <div class="lg__info">
                    ...
                    <div class="content-box">
                        <div style="position: relative;background: no-repeat;box-shadow:none;display:flex;margin: auto;">
                            <img class="col-lg-8 m-auto shadow" src="/img/san_juan.jpg" alt="lanzarote San Juan">
                            <img class="col-lg-8 m-auto d-none d-lg-block shadow-none" style="position: absolute;width: 150px;right: 54px;                            bottom: -24px;" src="/img/lanza-logo.png" alt="lanzarote logo">
                        </div>
                        ...
                        <div class="row w-100 p-0 bg-transparent shadow-none">
